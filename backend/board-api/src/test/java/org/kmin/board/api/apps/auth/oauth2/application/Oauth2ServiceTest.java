package org.kmin.board.api.apps.auth.oauth2.application;
...
import org.kmin.board.api.apps.auth.basic.application.LoginService;
import org.kmin.board.domain.user.UserRoleType;
import org.kmin.board.api.common.exception.ApplicationException;
import org.kmin.board.api.apps.auth.oauth2.application.exception.AuthorizationRequestRejectedException;
import org.kmin.board.api.apps.auth.oauth2.application.exception.Oauth2ProviderNotProvideException;
...
import org.kmin.board.api.apps.auth.oauth2.infrastrcture.oauth2.google.GoogleOauth2Client;
import org.kmin.board.api.apps.auth.oauth2.infrastrcture.oauth2.kakao.KakaoOauth2Client;
import org.kmin.board.api.apps.auth.oauth2.infrastrcture.oauth2.naver.NaverOauth2Client;
