...
import com.back.auth.domain.exception.AuthorizationRequestRejectedException;
import com.back.auth.domain.exception.Oauth2ProviderNotProvideException;
import com.back.auth.domain.Oauth2ProviderType;
import com.back.auth.infrastructure.oauth2.dto.Oauth2UserResponse;
import com.back.auth.infrastructure.oauth2.google.GoogleOauth2Client;
import com.back.auth.infrastructure.oauth2.kakao.KakaoOauth2Client;
import com.back.auth.infrastructure.oauth2.naver.NaverOauth2Client;
